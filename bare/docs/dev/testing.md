...
pytest --cov=./bare --cov-report=term-missing tests

# Generate HTML coverage report
pytest --cov=./bare --cov-report=html tests
# Open htmlcov/index.html in your browser

# Show coverage for specific file
pytest --cov=./bare/services/cache.py tests/services/test_cache.py
```
...
pytest --cov=./bare --cov-fail-under=80 tests
```
