...
- **`bare/conf/settings.py`**: Main Settings class
- **`bare/settings.py`**: Global settings instance
...
```python
from bare.conf import settings
...
```python
from bare.conf.cache import CacheSettings
