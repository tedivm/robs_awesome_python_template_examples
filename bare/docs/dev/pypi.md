...
# Install from wheel
pip install dist/bare-*.whl

# Verify installation
python -c "import bare; print(bare.__version__)"
...
1. Go to your project page: `https://pypi.org/project/bare/`
...
```bash
# View on PyPI
open https://pypi.org/project/bare/
