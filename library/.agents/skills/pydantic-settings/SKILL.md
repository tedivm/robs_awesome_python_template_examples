...
- **One settings class**: The main `Settings` class lives at `library/conf/settings.py`. Always update this existing class — never create a new settings class.
...
class Settings(BaseSettings):
    ...
    project_name: str = Field(default="library", description="Human-readable project name")
...
1. Open `library/conf/settings.py`.
