...
ls dist/
# library-1.2.3.tar.gz
# library-1.2.3-py3-none-any.whl
```
...
1. Go to your project page: `https://pypi.org/project/library/`
...
```bash
# View on PyPI
open https://pypi.org/project/library/
