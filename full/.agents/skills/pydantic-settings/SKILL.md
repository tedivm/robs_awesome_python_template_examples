...
- **One settings class**: The main `Settings` class lives at `full/conf/settings.py`. Always update this existing class — never create a new settings class.
...
class Settings(BaseSettings):
    ...
    project_name: str = Field(default="full", description="Human-readable project name")
