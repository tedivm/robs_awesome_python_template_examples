...
Models live in `full/models/`. Import and extend the shared `Base` from `full.models.base`.
...
- Models → `full/models/<domain>.py`
- Base class → `full/models/base.py` (do not modify)
...
- [ ] Model extends `Base` from `full.models.base`
- [ ] Model lives in `full/models/`
