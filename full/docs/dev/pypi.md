...
# Install from wheel
pip install dist/full-*.whl

# Verify installation
python -c "import full; print(full.__version__)"
...
1. Go to your project page: `https://pypi.org/project/full/`
...
```bash
# View on PyPI
open https://pypi.org/project/full/
