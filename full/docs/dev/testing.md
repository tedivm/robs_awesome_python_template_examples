...
pytest --cov=./full --cov-report=term-missing tests

# Generate HTML coverage report
pytest --cov=./full --cov-report=html tests
# Open htmlcov/index.html in your browser

# Show coverage for specific file
pytest --cov=./full/services/cache.py tests/services/test_cache.py
```
...
def test_celery_task_registration():
    ...
    from full.celery import celery, my_task
...
async def test_quasiqueue_job_execution():
    ...
    from full.qq import MyJobDefinition
...
pytest --cov=./full --cov-fail-under=80 tests
```
