...
- **Images**:
  ...
  - `ghcr.io/EXAMPLE/full.celery` - Celery workers
...
python -c "from full._version import version; print(version)"
...
- `ghcr.io/EXAMPLE/full.www`
- `ghcr.io/EXAMPLE/full.celery`
...
docker pull ghcr.io/EXAMPLE/full.www:main
...
services:
  www:
    image: ghcr.io/EXAMPLE/full.www:v1.2.3
```
