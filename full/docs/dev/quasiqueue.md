...
QuasiQueue is initialized in `full/qq.py` with three main components:
...
```python
import inspect
from full.qq import context, reader
...
# systemd unit file
[Service]
ExecStart=/path/to/venv/bin/python -m full.qq
Restart=always
```
