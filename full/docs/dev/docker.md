...
docker build -f dockerfile.www -t full-www:latest .

# Tag for registry
docker tag full-www:latest ghcr.io/your-org/full-www:latest

# Push to registry
docker push ghcr.io/your-org/full-www:latest
```
...
FROM ghcr.io/multi-py/python-uvicorn:py3.11-slim-LATEST AS builder
...
services:
  www:
    image: ghcr.io/your-org/full-www:latest
    restart: always
...
# Run a command
docker-compose exec www python -m full.cli version

# Check database connection
docker-compose exec www python -c "from full.services.db import engine; print(engine)"
```
...
3. Images are pushed to `ghcr.io/EXAMPLE/full`

### Pull Images from Registry

```bash
# Pull latest image
docker pull ghcr.io/EXAMPLE/full-www:latest

# Pull specific version
docker pull ghcr.io/EXAMPLE/full-www:v1.2.3

# Use in docker-compose
services:
  www:
    image: ghcr.io/EXAMPLE/full-www:latest
```
